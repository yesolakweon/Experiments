...
$featurearray = array("성별" => array("남성","여성"),"나이" => array("40세","46세","50세","58세"),"학력" => array("지방대 법학과 졸업","SKY 법학과 졸업","미국 대학원 박사"),"현 직책" => array("현 비례대표 국회의원","현 지역구 국회의원"),"경력" => array("대학교수","서울시의회 시의원","서울 중앙지방검찰청 검사"),"국회의원 당선 경력" => array("초선","재선","삼선"),"정당" => array("자유한국당","더불어민주당"));
