...
$featurearray = array("성별" => array("여성","남성"),"나이" => array("46세","52세","58세"),"학력" => array("지방대 졸업","SKY 졸업"),"현 직책" => array("현 비례대표 국회의원","현 지역구 국회의원"),"경력" => array("대학교수","서울시의회 시의원","검사"),"소속정당" => array("자유한국당","더불어민주당"));
